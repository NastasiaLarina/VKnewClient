...
final class Animator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    private let firstViewController: GaleryViewController
    private let secondViewController: PhotoViewController
    ...
    // 10
    init?(type: PresentationType, firstViewController: GaleryViewController, secondViewController: PhotoViewController, selectedCellImageViewSnapshot: UIView) {
        self.type = type
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        // 48
        // 54
        [backgroundView, selectedCellImageViewSnapshot, controllerImageSnapshot,
            closeButtonSnapshot].forEach { containerView.addSubview($0) }
